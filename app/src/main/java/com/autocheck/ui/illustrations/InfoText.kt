...
const val bikeReifen = "Profil und Abnutzung: Das Reifenprofil sollte eine ausreichende Tiefe haben und keine Risse oder sonstige Beschädigungen aufweisen. Die Abnutzung sollte gleichmäßg sein (Unebenheiten könnte auf defekte Federn oder Ausrichtung hinweisen) DOT: Die Vierstellige (KW/JAHR) zeigt das alter der Reifen an. Die Reifen sollten nicht älter als 8 Jahre sein Luftdruck: Achte darauf, dass der Reifen einen optimalen Luftdruck aufweist (im Handbuch findest du den optimalen Reifendruck), der Reifen sollte nicht platt aussehen. Saisonale Reifen: Achte darauf, dass die montierten Reifen zur aktuellen Saison passen (Winter-oder Sommerreifen), der Reifentyp ist an der Reifenwand gekennzeichnet"

const val bikeCockpit = "Kilometerstand: Überprüfe den Tachometer auf Unregelmäßigkeiten, ein abgeänderter Tachometer könnte einen ungewöhnlich niedrigen Kilometerstand aufweisen Schalter und Bedienelemente: Teste alle Schalter und Bedienelemente auf Funktion, hierbei sollten alle Knöpfe funktionieren und Ihren Zweck erfüllen Spiegel: Kontrolliere die Spiegel Beschädigungen, diese sollten fest montiert sein und nicht wackeln Elektronik: Teste, ob im Tacho alle Beleuchtungen sowie alle Elemente auf deinen Input reagieren und somit funktionieren"

const val carInnen =
        "1. Rückspiegel: sollte fest sein und nicht angelaufen sein \n" +
