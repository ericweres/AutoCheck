...
/**
 * Composable-Funktion für die Anzeige einer Motorrad-Illustration.
 *
 * Diese Funktion erstellt die Benutzeroberfläche zum Visualisieren verschiedener Teile eines Fahrzeugs.
 *
 ...
 */
@Composable
fun IllustBike(@Suppress ("UNUSED_PARAMETER") modifier: Modifier, navController: NavHostController, vehicleId: Int?) {
    // Mutable-Zustandsvariablen
    ...
    // ViewModel zum Verarbeiten von Fahrzeugdaten
    val vehicleViewModel: VehicleViewModel = hiltViewModel()
    val selectedVehicle by vehicleViewModel.selectedVehicle.collectAsState()

    // Holen Sie Fahrzeugdaten nach ID, wenn verfügbar
    if (vehicleId != null) {
    ...
    if (showDialog2) {
        ...
        // Zeige eine Fehlermeldung an, wenn vehicleId null ist
